 ...
 ?>
  ...
  <div class="headerContainer">
            <header>
                ...
                <ul>
              <li><a href="/projeto_programacao_web/index.php">Início</a></li>
                <li><a href="/projeto_programacao_web/sobre.php">Sobre</a></li>
                 <li><a href="/projeto_programacao_web/produtos.php">Produtos</a></li>
                 <li><a href="/projeto_programacao_web/contato.php">Fale conosco</a></li>
                  <li><a href="/projeto_programacao_web/admin/dashboard.php">Admin</a></li>
